...
class RangeReadyStack extends Stack {
  ...
  //
  ////////////////////////////////////////////////////////////////////////
  static configureResourceNames(namespace) {
    const resourceNames = {
      aliasRecord: `${namespace}AliasRecord`,
      ...
      viewerRequestHandler: `${namespace}ViewerRequestHandler`,
    };
    return resourceNames;
  }
}

export { RangeReadyStack };
